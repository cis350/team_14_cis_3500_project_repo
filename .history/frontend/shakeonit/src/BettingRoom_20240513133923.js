    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Optionally, re-fetch event details or update local state to show the user as a participant
                fetchEvent(); // assuming fetchEvent() fetches the latest event data including participants
            } else {
